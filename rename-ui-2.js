...
const replacements = [
    ...
    { file: 'src/components/sidebar/Sidebar.js', from: />Subjects</g, to: '>Skill Trees<' },
    ...
    { file: 'src/components/sidebar/Sidebar.js', from: />Question Type</g, to: '>Practice Style<' },
    ...
    { file: 'src/components/sidebar/Sidebar.js', from: />Units</g, to: '>Topics<' },
    ...
    { file: 'src/components/sidebar/Sidebar.js', from: />Chapters</g, to: '>Exercise Sets<' },
];
